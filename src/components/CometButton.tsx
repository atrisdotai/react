...
export default (props: any) => {
  ...
  if (!account) {
    ...
    buttonContent = (
      <div
        className='inline-block font-medium w-36 text-center ml-2' style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}
      >
        Login with Comet
      </div>
    )
  } else {
    iconContent = <Avatar user={account} width={28} className='inline-block -mt-0.5 -mb-0.5 -ml-1 mr-1.5' />
    buttonContent = (
      <div
        className='inline-block font-medium w-36 text-center ml-2' style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}
      >
