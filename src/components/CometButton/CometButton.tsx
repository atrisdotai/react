  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <div className='inline-block w-44 align-center' style={{ width: 169, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
          {
            user
              ? `@${user.username}`
              : 'Login with Comet'
...

      {
        !modalOpen && (
          <iframe
            className='hidden'
            src={`${props.baseUrl || 'https://auth.withcomet.com'}/login`}
          />
        )
      }
    </React.Fragment>
